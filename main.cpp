...
B: симметрична€ (хр как верхнетреугольна€)
b00 b01 b02 b03
0   b11 b12 b13
0   0   b22 b23
0   0   0   b33
...
// »ндекс элемента (i, j) нижнетреугольной матрицы в одномерном массиве
...
// »ндекс элемента (i, j) симметричной матрицы в одномерном массиве
...
// Ёлемент (i, j) блока (bI, bJ) в одномерном массиве нижнетреугольной матрицы
...
// Ёлемент (i, j) блока (bI, bJ) в одномерном массиве симметричной матрицы
...
void measureTime()
{
	...
	A = fillTriang();
	B = fillTriang();
	// создаем квадратные(!) матрицы, с нул€ми. 
	// их перемножить, дл€ сравнени€ потом 
	// создать блоки
